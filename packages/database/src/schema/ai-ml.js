...
exports.resumeAnalysis = exports.parsedResumeData = exports.mlModels = exports.userRecommendationPreferences = exports.recommendationLogs = exports.userInteractions = exports.parsingStatusEnum = exports.diversityLevelEnum = exports.userActionEnum = exports.interactionTypeEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const users_1 = require("./users");
const jobs_1 = require("./jobs");
const profiles_1 = require("./profiles");
exports.interactionTypeEnum = (0, pg_core_1.pgEnum)('interaction_type', ['view', 'apply', 'save', 'share', 'not_interested']);
exports.userActionEnum = (0, pg_core_1.pgEnum)('user_action', ['viewed', 'applied', 'saved', 'ignored', 'not_interested']);
exports.diversityLevelEnum = (0, pg_core_1.pgEnum)('diversity_level', ['low', 'medium', 'high']);
exports.parsingStatusEnum = (0, pg_core_1.pgEnum)('parsing_status', ['pending', 'processing', 'completed', 'failed']);
...
exports.userRecommendationPreferences = (0, pg_core_1.pgTable)('user_recommendation_preferences', {
    ...
    minMatchScoreForNotification: (0, pg_core_1.integer)('min_match_score_for_notification').default(85),
...
exports.parsedResumeData = (0, pg_core_1.pgTable)('parsed_resume_data', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    resumeId: (0, pg_core_1.uuid)('resume_id').notNull().references(() => profiles_1.resumes.id, { onDelete: 'cascade' }),
    userId: (0, pg_core_1.uuid)('user_id').notNull().references(() => users_1.users.id, { onDelete: 'cascade' }),
