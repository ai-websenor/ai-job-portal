export declare const interactionTypeEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["view", "apply", "save", "share", "not_interested"]>;
export declare const userActionEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["viewed", "applied", "saved", "ignored", "not_interested"]>;
export declare const diversityLevelEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["low", "medium", "high"]>;
export declare const parsingStatusEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["pending", "processing", "completed", "failed"]>;
