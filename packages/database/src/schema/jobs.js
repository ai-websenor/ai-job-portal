...
exports.jobAlerts = exports.savedJobs = exports.jobCategoryRelations = exports.jobCategories = exports.screeningQuestions = exports.jobs = exports.experienceLevelEnum = exports.jobTypeEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const users_1 = require("./users");
exports.jobTypeEnum = (0, pg_core_1.pgEnum)('job_type', ['full_time', 'part_time', 'contract', 'gig', 'remote']);
exports.experienceLevelEnum = (0, pg_core_1.pgEnum)('experience_level', ['entry', 'mid', 'senior', 'lead']);
exports.jobs = (0, pg_core_1.pgTable)('jobs', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    employerId: (0, pg_core_1.uuid)('employer_id').notNull().references(() => users_1.employers.id, { onDelete: 'cascade' }),
...
exports.screeningQuestions = (0, pg_core_1.pgTable)('screening_questions', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    jobId: (0, pg_core_1.uuid)('job_id').notNull().references(() => exports.jobs.id, { onDelete: 'cascade' }),
...
exports.jobCategoryRelations = (0, pg_core_1.pgTable)('job_category_relations', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    jobId: (0, pg_core_1.uuid)('job_id').notNull().references(() => exports.jobs.id, { onDelete: 'cascade' }),
    categoryId: (0, pg_core_1.uuid)('category_id').notNull().references(() => exports.jobCategories.id, { onDelete: 'cascade' }),
    createdAt: (0, pg_core_1.timestamp)('created_at').notNull().defaultNow(),
});
