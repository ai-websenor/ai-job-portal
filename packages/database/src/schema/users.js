...
exports.teamMembers = exports.employers = exports.subscriptionPlanEnum = exports.education = exports.workExperience = exports.jobSeekers = exports.users = exports.userRoleEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
exports.userRoleEnum = (0, pg_core_1.pgEnum)('user_role', ['candidate', 'employer', 'admin', 'team_member']);
...
exports.workExperience = (0, pg_core_1.pgTable)('work_experience', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    jobSeekerId: (0, pg_core_1.uuid)('job_seeker_id').notNull().references(() => exports.jobSeekers.id, { onDelete: 'cascade' }),
...
exports.subscriptionPlanEnum = (0, pg_core_1.pgEnum)('subscription_plan', ['free', 'basic', 'premium', 'enterprise']);
exports.employers = (0, pg_core_1.pgTable)('employers', {
    ...
    description: (0, pg_core_1.text)('description'),
    isVerified: (0, pg_core_1.boolean)('is_verified').notNull().default(false),
    subscriptionPlan: (0, exports.subscriptionPlanEnum)('subscription_plan').notNull().default('free'),
...
exports.teamMembers = (0, pg_core_1.pgTable)('team_members', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    employerId: (0, pg_core_1.uuid)('employer_id').notNull().references(() => exports.employers.id, { onDelete: 'cascade' }),
    userId: (0, pg_core_1.uuid)('user_id').notNull().references(() => exports.users.id, { onDelete: 'cascade' }),
