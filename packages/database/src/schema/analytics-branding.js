...
exports.regionalPricing = exports.regions = exports.employeeTestimonials = exports.companyMedia = exports.companyPages = exports.metricCache = exports.analyticsEvents = exports.mediaTypeEnum = exports.brandingTierEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const users_1 = require("./users");
exports.brandingTierEnum = (0, pg_core_1.pgEnum)('branding_tier', ['free', 'premium', 'enterprise']);
...
exports.regionalPricing = (0, pg_core_1.pgTable)('regional_pricing', {
    ...
    regionId: (0, pg_core_1.uuid)('region_id').notNull().references(() => exports.regions.id, { onDelete: 'cascade' }),
