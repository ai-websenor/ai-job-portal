export declare const videoStatusEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["uploading", "processing", "approved", "rejected", "active"]>;
export declare const privacySettingEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["public", "employers_only", "private"]>;
export declare const moderationStatusEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["pending", "approved", "rejected"]>;
export declare const senderEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["user", "bot", "agent"]>;
