...
exports.chatMessages = exports.chatSessions = exports.messages = exports.messageThreads = exports.videoAnalytics = exports.videoResumes = exports.senderEnum = exports.moderationStatusEnum = exports.privacySettingEnum = exports.videoStatusEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const users_1 = require("./users");
exports.videoStatusEnum = (0, pg_core_1.pgEnum)('video_status', ['uploading', 'processing', 'approved', 'rejected', 'active']);
exports.privacySettingEnum = (0, pg_core_1.pgEnum)('privacy_setting', ['public', 'employers_only', 'private']);
exports.moderationStatusEnum = (0, pg_core_1.pgEnum)('moderation_status', ['pending', 'approved', 'rejected']);
...
exports.videoAnalytics = (0, pg_core_1.pgTable)('video_analytics', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    videoId: (0, pg_core_1.uuid)('video_id').notNull().references(() => exports.videoResumes.id, { onDelete: 'cascade' }),
    viewerId: (0, pg_core_1.uuid)('viewer_id').references(() => users_1.users.id, { onDelete: 'set null' }),
...
exports.messages = (0, pg_core_1.pgTable)('messages', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    threadId: (0, pg_core_1.uuid)('thread_id').notNull().references(() => exports.messageThreads.id, { onDelete: 'cascade' }),
    senderId: (0, pg_core_1.uuid)('sender_id').notNull().references(() => users_1.users.id, { onDelete: 'cascade' }),
    recipientId: (0, pg_core_1.uuid)('recipient_id').notNull().references(() => users_1.users.id, { onDelete: 'cascade' }),
...
exports.chatMessages = (0, pg_core_1.pgTable)('chat_messages', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    sessionId: (0, pg_core_1.uuid)('session_id').notNull().references(() => exports.chatSessions.id, { onDelete: 'cascade' }),
