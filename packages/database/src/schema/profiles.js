...
exports.profileViews = exports.profileDocuments = exports.jobPreferences = exports.resumes = exports.certifications = exports.profileSkills = exports.skills = exports.educationRecords = exports.workExperiences = exports.profiles = exports.workShiftEnum = exports.documentTypeEnum = exports.jobSearchStatusEnum = exports.noticePeriodEnum = exports.fileTypeEnum = exports.proficiencyLevelEnum = exports.skillCategoryEnum = exports.educationLevelEnum = exports.employmentTypeEnum = exports.visibilityEnum = exports.genderEnum = void 0;
...
exports.employmentTypeEnum = (0, pg_core_1.pgEnum)('employment_type', ['full_time', 'part_time', 'contract', 'internship', 'freelance']);
exports.educationLevelEnum = (0, pg_core_1.pgEnum)('education_level', ['high_school', 'bachelors', 'masters', 'phd', 'diploma', 'certificate']);
exports.skillCategoryEnum = (0, pg_core_1.pgEnum)('skill_category', ['technical', 'soft', 'language', 'industry_specific']);
exports.proficiencyLevelEnum = (0, pg_core_1.pgEnum)('proficiency_level', ['beginner', 'intermediate', 'advanced', 'expert']);
exports.fileTypeEnum = (0, pg_core_1.pgEnum)('file_type', ['pdf', 'doc', 'docx']);
exports.noticePeriodEnum = (0, pg_core_1.pgEnum)('notice_period', ['immediate', '15_days', '1_month', '2_months', '3_months']);
exports.jobSearchStatusEnum = (0, pg_core_1.pgEnum)('job_search_status', ['actively_looking', 'open_to_opportunities', 'not_looking']);
exports.documentTypeEnum = (0, pg_core_1.pgEnum)('document_type', ['resume', 'cover_letter', 'certificate', 'id_proof', 'portfolio', 'other']);
exports.workShiftEnum = (0, pg_core_1.pgEnum)('work_shift', ['day', 'night', 'rotational', 'flexible']);
exports.profiles = (0, pg_core_1.pgTable)('profiles', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    userId: (0, pg_core_1.uuid)('user_id').notNull().references(() => users_1.users.id, { onDelete: 'cascade' }).unique(),
    ...
    totalExperienceYears: (0, pg_core_1.decimal)('total_experience_years', { precision: 4, scale: 2 }),
...
exports.workExperiences = (0, pg_core_1.pgTable)('work_experiences', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    profileId: (0, pg_core_1.uuid)('profile_id').notNull().references(() => exports.profiles.id, { onDelete: 'cascade' }),
...
exports.profileSkills = (0, pg_core_1.pgTable)('profile_skills', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    profileId: (0, pg_core_1.uuid)('profile_id').notNull().references(() => exports.profiles.id, { onDelete: 'cascade' }),
    skillId: (0, pg_core_1.uuid)('skill_id').notNull().references(() => exports.skills.id, { onDelete: 'cascade' }),
...
exports.jobPreferences = (0, pg_core_1.pgTable)('job_preferences', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    profileId: (0, pg_core_1.uuid)('profile_id').notNull().references(() => exports.profiles.id, { onDelete: 'cascade' }).unique(),
...
exports.profileViews = (0, pg_core_1.pgTable)('profile_views', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    profileId: (0, pg_core_1.uuid)('profile_id').notNull().references(() => exports.profiles.id, { onDelete: 'cascade' }),
    employerId: (0, pg_core_1.uuid)('employer_id').notNull().references(() => users_1.users.id, { onDelete: 'cascade' }),
