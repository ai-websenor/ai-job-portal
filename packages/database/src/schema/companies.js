...
exports.applicantTags = exports.applicantNotes = exports.jobShares = exports.shareChannelEnum = exports.jobViews = exports.savedSearches = exports.companies = exports.verificationStatusEnum = exports.companyTypeEnum = exports.companySizeEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const users_1 = require("./users");
const jobs_1 = require("./jobs");
exports.companySizeEnum = (0, pg_core_1.pgEnum)('company_size', ['1-10', '11-50', '51-200', '201-500', '500+']);
exports.companyTypeEnum = (0, pg_core_1.pgEnum)('company_type', ['startup', 'sme', 'mnc', 'government']);
exports.verificationStatusEnum = (0, pg_core_1.pgEnum)('verification_status', ['pending', 'verified', 'rejected']);
...
exports.shareChannelEnum = (0, pg_core_1.pgEnum)('share_channel', ['whatsapp', 'email', 'linkedin', 'twitter', 'facebook', 'copy_link']);
...
exports.applicantTags = (0, pg_core_1.pgTable)('applicant_tags', {
    ...
    createdBy: (0, pg_core_1.uuid)('created_by').notNull().references(() => users_1.users.id, { onDelete: 'cascade' }),
    createdAt: (0, pg_core_1.timestamp)('created_at').notNull().defaultNow(),
});
