...
exports.adminActivityLog = (0, pg_core_1.pgTable)('admin_activity_log', {
  ...
  adminUserId: (0, pg_core_1.uuid)('admin_user_id')
    .notNull()
    .references(() => exports.adminUsers.id, { onDelete: 'cascade' }),
