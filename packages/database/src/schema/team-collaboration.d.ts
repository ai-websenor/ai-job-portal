export declare const teamRoleEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["admin", "recruiter", "hiring_manager", "interviewer", "viewer"]>;
export declare const taskPriorityEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["high", "medium", "low"]>;
export declare const taskStatusEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["open", "in_progress", "completed", "canceled"]>;
export declare const relatedToTypeEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["job", "candidate", "interview"]>;
export declare const entityTypeEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["candidate", "job", "task", "note"]>;
