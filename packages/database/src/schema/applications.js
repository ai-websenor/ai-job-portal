...
exports.applicationHistory = exports.interviews = exports.interviewStatusEnum = exports.applications = exports.applicationStatusEnum = void 0;
...
exports.applications = (0, pg_core_1.pgTable)('applications', {
    ...
    jobSeekerId: (0, pg_core_1.uuid)('job_seeker_id').notNull().references(() => users_1.jobSeekers.id, { onDelete: 'cascade' }),
