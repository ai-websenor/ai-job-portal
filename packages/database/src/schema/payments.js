...
exports.invoices = exports.transactionHistory = exports.subscriptions = exports.payments = exports.paymentMethodEnum = exports.paymentStatusEnum = void 0;
...
exports.transactionHistory = (0, pg_core_1.pgTable)('transaction_history', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    paymentId: (0, pg_core_1.uuid)('payment_id').notNull().references(() => exports.payments.id, { onDelete: 'cascade' }),
...
exports.invoices = (0, pg_core_1.pgTable)('invoices', {
    ...
    amount: (0, pg_core_1.decimal)('amount', { precision: 10, scale: 2 }).notNull(),
    taxAmount: (0, pg_core_1.decimal)('tax_amount', { precision: 10, scale: 2 }).notNull().default('0'),
