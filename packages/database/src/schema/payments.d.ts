export declare const paymentStatusEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["pending", "success", "failed", "refunded"]>;
export declare const paymentMethodEnum: import("node_modules/drizzle-orm/pg-core").PgEnum<["credit_card", "debit_card", "upi", "netbanking", "wallet"]>;
