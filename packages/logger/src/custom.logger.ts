...
export class CustomLogger implements LoggerService {
    ...
    error(message: string, ...optionalParams: any[]) { // Adjusted signature to match LoggerService
        ...
        const data = typeof optionalParams[1] === 'object' && !(optionalParams[1] instanceof Error) ? optionalParams[1] : undefined;
