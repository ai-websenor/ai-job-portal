    ...
    <>
      ...
      <div className="container mx-auto py-6 px-4 md:px-6 space-y-5">
          ...
          >
              ...
              <div className="space-y-6 bg-white p-5">
                <section>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    You'll be part of a team working on designing and building
                    Search experiences for New Internet Users and Next Billion
                    Users (NBU), in a team that is research-led and focused on
                    building Search engagement...{" "}
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm text-gray-600">
                    <li>
                      Interest or experience in designing for emerging markets
                      and new internet users.
                    </li>
                    <li>
                      Strong core mobile interaction design skills to solve
                      complex user flows and visually organized data and to
                      build cohesive design frameworks.
                    </li>
                    <li>
                      Solid command of typography, layout, and information
                      hierarchy.
                    </li>
            ...
            <Tab key="about" title="About Company" className="p-5">
              <div className="space-y-6 bg-white p-5">
                ...
                <Card
                  shadow="none"
                  className="border border-gray-100 bg-gray-50/30"
                >
        ...
        <div className="flex justify-end">
          <Button
            color="primary"
            onPress={() => router.push(routePaths.employee.jobs.live("asdff"))}
            className="bg-primary text-white font-semibold px-12 shadow-md shadow-primary/20"
          >
            Post Job
          </Button>
        </div>
