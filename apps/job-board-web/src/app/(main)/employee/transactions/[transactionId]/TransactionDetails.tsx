import { Card, CardBody, CardHeader, Divider, Chip, Snippet } from '@heroui/react';
import {
  MdCheckCircle,
  MdOutlineAccessTime,
  MdOutlinePayment,
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <h2 className="text-4xl font-bold text-primary flex items-baseline gap-1">
                    <span className="text-2xl font-medium">{transaction.currency}</span>
                    {transaction.amount}
                  </h2>
                </div>
              </div>
          ...
          <CardBody className="px-6 pb-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-2 border-b border-default-100 pb-4">
                ...
                <span className="font-medium">
                  {transaction.currency} {transaction.taxAmount}
                </span>
              </div>
      ...
      <div className="space-y-6">
        ...
        {(Number(transaction.refundAmount) > 0 || transaction.refundedAt) && (
          <Card className="shadow-sm border-none bg-danger-50 text-danger-600">
            <CardBody className="p-4 items-center gap-2 flex-row">
              ...
              <div>
                ...
                <p className="text-xs">
                  {transaction.currency} {transaction.refundAmount} refunded
                </p>
              </div>
            </CardBody>
          </Card>
        ...
        <div className="p-4 bg-default-100 rounded-2xl flex items-center justify-between">
          ...
          <span className="text-xs font-mono text-default-400">{transaction.userId}</span>
        </div>
      </div>
    </div>
  );
