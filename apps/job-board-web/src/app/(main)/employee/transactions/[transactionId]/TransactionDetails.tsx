              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <h2 className="text-5xl font-black text-primary flex items-baseline gap-2">
                    <span className="text-2xl font-semibold opacity-70">{transaction.currency}</span>
            ...
            <div className="space-y-5">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  <span className="text-default-500 font-medium lowercase">Item/Subscription</span>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    {transaction.discountCodeId && (
                      <Chip size="sm" color="success" variant="flat" className="h-5 px-1 text-[10px]">
                        {transaction.discountCodeId}
                      </Chip>
                    )}
                  </div>
      ...
      <div className="space-y-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-baseline">
                  <p className="text-xs font-medium opacity-80">
                    {transaction.refundedAt ? dayjs(transaction.refundedAt).format('MMM D, YYYY') : 'Recently'}
                  </p>
        ...
        <div className="p-5 bg-default-100/50 rounded-3xl border border-default-200/50 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-black text-default-400 uppercase">Tracking Hub</span>
