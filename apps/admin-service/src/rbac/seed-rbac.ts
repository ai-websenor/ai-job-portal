...
const DEFAULT_PERMISSIONS = [
  ...
  // Jobs
  { name: 'jobs:read', resource: 'jobs', action: 'read', description: 'View jobs' },
  { name: 'jobs:write', resource: 'jobs', action: 'write', description: 'Create and edit jobs' },
  { name: 'jobs:delete', resource: 'jobs', action: 'delete', description: 'Delete jobs' },
  {
    name: 'jobs:moderate',
    resource: 'jobs',
    action: 'moderate',
    description: 'Moderate and approve jobs',
  },
...
const ROLE_PERMISSIONS = {
  ...
  ADMIN: {
    name: 'ADMIN',
    description: 'Company administrator with access to company-scoped features',
    permissions: [
      'analytics:read',
      'employers:read',
      'employers:write',
  ...
  EMPLOYERS: {
    name: 'EMPLOYERS',
    description: 'Employer role with limited access to job and application management',
    permissions: [
      'jobs:read',
      'jobs:write',
      'applications:read',
