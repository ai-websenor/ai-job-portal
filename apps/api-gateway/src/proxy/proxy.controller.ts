...
export class ProxyController {
  ...
  constructor(
    ...
    private readonly proxySpecialService: ProxySpecialService,
  ) {}
  ...
  async proxyLinkEvent(@Req() req: FastifyRequest, @Res() res: FastifyReply) {
    return this.proxySpecialService.forwardLinkEvent(req, res);
  }
  ...
  async proxyWebhooks(@Req() req: FastifyRequest, @Res() res: FastifyReply) {
    return this.proxySpecialService.forwardWebhook(req, res);
  }
  ...
  private async proxyAiRequest(req: FastifyRequest, res: FastifyReply) {
    return this.proxySpecialService.forwardAiRequest(req, res);
  }
