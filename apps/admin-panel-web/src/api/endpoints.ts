const endpoints = {
  ...
  reports: {
    ...
    jobStats: '/reports/jobs',
    jobCategories: '/reports/jobs/categories',
    jobsOverTime: '/reports/jobs/over-time',
    applicationStats: '/reports/applications',
    applicationsOverTime: '/reports/applications/over-time',
    interviewStats: '/reports/interviews',
    candidateAnalytics: '/reports/candidates/analytics',
    employerAnalytics: '/reports/employers/analytics',
    topEmployers: '/reports/employers/top',
    hiringFunnel: '/reports/hiring-funnel',
    revenueStats: '/reports/revenue',
    revenueReport: '/reports/revenue/report',
    revenueByEmployer: '/reports/revenue/by-employer',
  },
  attachment: {
